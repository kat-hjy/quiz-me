...
This Python-based project allows the users to create quiz questions based on the module contents.
...
| :------- | :------------ | :--------- |:--------- |:--------- |
| NUR1124  | Y (MCQ, 30%)       | 10 questions each for the 3 components | Y (MCQ, 60%)    | 20 questions each for the 3 components |
| NUR2125  | Y (MCQ)       | | Y (MCQ)    |  |
| MIC2000A | Y (MCQ)       | | Y (MCQ)    |  |
| NUR2124  | N             | | N          |  |
| MD1902   | N             | | Y (Essay)  |  |
| PL1101E  | N             | | N          |  |
...
The documents are mainly classified into:
...
1. module information: for generating the scope of the exams
